...
%o`, message, error2, detail);
  ...
  var chat_refresh_controller_default = class extends Controller {
    ...
    subscribe() {
      ...
      this.channel = cable_exports.subscribeTo({ channel: channelName, signed_stream_name: signedStreamName }, {
        received(data) {
  ...
  application.register("chat_refresh", chat_refresh_controller_default);
})();
